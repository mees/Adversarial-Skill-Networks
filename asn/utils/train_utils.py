...
from asn.utils.sampler import ViewPairSequenceSampler, SkillViewPairSequenceSampler
...
def get_dataloader_train(dir_vids, num_views, batch_size, use_cuda, img_size=299, filter_func=None, label_funcs=None,
...
def get_skill_dataloader(dir_vids, num_views, batch_size, use_cuda, img_size, filter_func,
                         label_funcs, num_domain_frames=1, stride=1):
    ...
    if num_domain_frames > 1:
        ...
        sampler = SkillViewPairSequenceSampler(dataset=transformed_dataset_train_domain,
                                               stride=stride,
