...
<pre>
CUDA_VISIBLE_DEVICES=0 python train_asn.py --train-dir /tmp/real_combi_task3/videos/train/ --val-dir-metric /tmp/real_combi_task3/videos/val/ --save-folder /tmp/abd_to_c  --train-filter-tasks cstack 
</pre>
